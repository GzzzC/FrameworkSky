...
public class Test1TableMgr : ITableData
{
    public Test1TableMgr(DynamicPacket packet)
    {
        Deserialize(packet);
    }

    private Dictionary<int, Test1Table> mDict = new Dictionary<int, Test1Table>();
    
    public Dictionary<int, Test1Table> Dict
    {
        get {return mDict;}
    }
    ...
    public void Deserialize (DynamicPacket packet)
    {
        ...
        for (int i = 0; i < num; i++)
        {
            Test1Table item = new Test1Table();
    ...
    public Test1Table GetDataByID(int id)
    {
